...
private:
    ...
    uint32_t L[17]{};
    uint32_t R[17]{};
    uint8_t initial[64] = { 58, 50, 42, 34, 26, 18, 10,  2,
    ...
    uint8_t final[64] = { 40,  8, 48, 16, 56, 24, 64, 32,
    ...
    uint8_t PC2[48] = { 14, 17, 11, 24,  1,  5,
                        ...
                        30, 40, 51, 45, 33, 48,
                        44, 49, 39, 56, 34, 53,
                        46, 42, 50, 36, 29, 32 }; // PC-2
    uint8_t shiftTimes[16] = { 1, 1, 2, 2,
                               2, 2, 2, 2,
                               1, 2, 2, 2,
                               2, 2, 2, 1 }; // 位移次数表
    uint8_t SBox[8][4][16] = { { { 14,  4, 13,  1,  2, 15, 11,  8,  3, 10,  6, 12,  5,  9,  0,  7 }, /*S1*/
                               ...
                               { { 13,  2,  8,  4,  6, 15, 11,  1, 10,  9,  3, 14,  5,  0, 12,  7 }, /*S8*/
                                 ...
                                 {  2,  1, 14,  7,  4, 10,  8, 13, 15, 12,  9,  0,  3,  5,  6, 11 } } }; // 6进4出S盒
    uint8_t PBox[32] = { 16,  7, 20, 21, 29, 12, 28, 17,
                          1, 15, 23, 26,  5, 18, 31, 10,
                          2,  8, 24, 14, 32, 27,  3,  9,
                         19, 13, 30,  6, 22, 11,  4, 25 }; // P盒置换表
    uint8_t EBox[48] = { 32,  1,  2,  3,  4,  5,
                          4,  5,  6,  7,  8,  9,
                          8,  9, 10, 11, 12, 13,
                         12, 13, 14, 15, 16, 17,
                         16, 17, 18, 19, 20, 21,
